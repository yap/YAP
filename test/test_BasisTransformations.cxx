...
TEST_CASE( "BasisTransformations" )
{
    ...
    t1_cov[0][0][0][0] = 1.21;  t1_cov[0][0][0][1] = 0.101;
    t1_cov[0][0][1][0] = 0.218;  t1_cov[0][0][1][1] = 1.95;

    t1_cov[1][1][0][0] = 2.17;  t1_cov[1][1][0][1] = 0.153;
    t1_cov[1][1][1][0] = 0.156;  t1_cov[1][1][1][1] = 1.68;

    t1_cov[2][2][0][0] = 1.78;  t1_cov[2][2][0][1] = 0.278;
    t1_cov[2][2][1][0] = 0.279;  t1_cov[2][2][1][1] = 2.06;
